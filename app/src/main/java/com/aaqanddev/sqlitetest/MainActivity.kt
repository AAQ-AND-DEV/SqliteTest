package com.aaqanddev.sqlitetest
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val db = baseContext.openOrCreateDatabase("sqlite-test-1.db", Context.MODE_PRIVATE, null)
        /*
        ...
        val generatedId = db.insert("contacts", null, values)
         */
